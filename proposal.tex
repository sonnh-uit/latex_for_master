...
\title{Mẫu báo cáo latex cho đề cương thạc sĩ}
\titleen{Latex for mater proposal}
\supervisorname{TS. Google }
\stuname{NGUYỄN HỒNG SƠN }
\proposaltype{Luận văn thạc sĩ}
...
\mainmatter
% \backgroundsetup{contents=Confidential,placement=center,color=red}
