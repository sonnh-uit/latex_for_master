...
\title{Đánh giá hiệu năng và tính sẵn sàng của hệ thống Hadoop Distributed File System}
\titleen{Evaluating the Performance and Scalability of the Ceph Hadoop Distributed File System}
